// data/questions.js - مع الفئات الجديدة
...
export const sampleQuestions = [
  ...
  // ==================== Traitement et prévention (8 أسئلة) ====================
  {
    id: 6,
    topic: 'traitement',
